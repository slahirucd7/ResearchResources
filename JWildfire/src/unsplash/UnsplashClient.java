...
public class UnsplashClient {
    ...
    public UnsplashImage[] getPhotos(int page, int perPage, String query, UnsplashSort sort) {
        String url = UriUtils.addWebPaths(this.baseUrl, "/photos?page" + page + "&per_page=" + perPage + "&query=" + query + "&order_by=" + sort.toString().toLowerCase());
        return getJSON(url, UnsplashImage[].class);
    }

    public UnsplashQueryImage getPhotos(String queryParameter) {
        String url = UriUtils.addWebPaths(this.baseUrl, "/search/photos/?query=" + URLEncoder.encode(queryParameter));
        return getJSON(url, UnsplashQueryImage.class);
    }

    public UnsplashQueryImage getPhotos(String queryParameter,String page) {
        String url = UriUtils.addWebPaths(this.baseUrl, "/search/photos/?query=" + URLEncoder.encode(queryParameter)+ "&page=" + URLEncoder.encode(page));
        return getJSON(url, UnsplashQueryImage.class);
    }
